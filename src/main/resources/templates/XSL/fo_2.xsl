				...
				<fo:table table-layout="fixed" width="165mm" border-color="black" border-width="0.5mm" border-style="solid" text-align="center" display-align="center" space-after="1.5mm">
					...
					<fo:table-body>
						<fo:table-row height="7mm" font-size="6.5px" font-weight="bold">
							...
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block>Blue Block Code</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="7mm" font-size="5.4px">
							...
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block><xsl:value-of select="blueBlockCode"/></fo:block>
							</fo:table-cell>			
						</fo:table-row>
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5px" font-weight="bold">Approximate Closing Date</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
								<fo:block font-size="5.4px"><xsl:value-of select="approximateClosingDate"/></fo:block>
							</fo:table-cell>
						</fo:table-row>				
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5px" font-weight="bold">Number Of Days Late</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
								<fo:block font-size="5.4px"><xsl:value-of select="numberOfDaysLate"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
						...
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5px" font-weight="bold">Is Opened Before</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
								<fo:block font-size="5.4px"><xsl:value-of select="isOpenedBefore"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5px" font-weight="bold">Opened Before NCR No</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
								<fo:block font-size="5.4px"><xsl:value-of select="openedBeforeNCRNo"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
						...
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5" font-weight="bold">Description of performed corrective action</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
						...
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
								<fo:block font-size="6.5px" font-weight="bold">Type Of Test</fo:block>
							</fo:table-cell>							
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid"  number-columns-spanned="6">
								<fo:block font-size="5.4px"><xsl:value-of select="typeOfTest"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="7mm">
							<fo:table-cell border-color="black" border-width="0.175mm" border-style="solid">
