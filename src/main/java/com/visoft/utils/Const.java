...
//    int[] cellLengthFont20IL = {1, 10, 10, 9, 9, 10, 8, 9, 6};
    ...
    String[] CONFIG_ZERO_NCR_BODY_KEYS = {
            EXPECTED_CLOSING_DATE,
            UPDATED_EXPECTED_CLOSING_DATE,
            SUB_PROJECT,
            NCR_DESCRIPTION,
            RESPONSIBLE_PARTY_DESIGN_CONTRACTOR_SUPPLIER,
            CORRECTIVE_ACTION,
    ...
    String[] CONFIG_ZERO_NCR_BODY_VALUES = {
            EXPECTED_CLOSING_DATE_VAL,
            UPDATED_EXPECTED_CLOSING_DATE_VAL,
            SUB_PROJECT_VAL,
            NCR_DESCRIPTION_VAL,
            RESPONSIBLE_PARTY_DESIGN_CONTRACTOR_SUPPLIER_VAL,
            CORRECTIVE_ACTION_VAL,
    ...
    String[] CONFIG_ONE_NCR_BODY_KEYS = {
            APPROXIMATE_CLOSING_DATE_NCR_ONE,
            NUMBER_OF_DAYS_LATE,
            NCR_DESCRIPTION,
            RESPONSIBLE_PARTY_DESIGN_CONTRACTOR_SUPPLIER,
            RESPONSIBLE_PARTY_ROLE,
            IS_OPENED_BEFORE,
            OPENED_BEFORE_NCR_NO,
            CORRECTIVE_ACTION,
            DESCRIPTION_OF_PERFORMED_CORRECTIVE_ACTION,
            TYPE_OF_TEST,
            REMARKS
    ...
    String[] CONFIG_ONE_NCR_BODY_VALUES = {
            APPROXIMATE_CLOSING_DATE_VAL,
            NUMBER_OF_DAYS_LATE_VAL,
            NCR_DESCRIPTION_VAL,
            RESPONSIBLE_PARTY_DESIGN_CONTRACTOR_SUPPLIER_VAL,
            RESPONSIBLE_PARTY_ROLE_VAL,
            IS_OPENED_BEFORE_VAL,
            OPENED_BEFORE_NCR_NO_VAL,
            CORRECTIVE_ACTION_VAL,
            DESCRIPTION_OF_PERFORMED_CORRECTIVE_ACTION_VAL,
            TYPE_OF_TEST_VAL,
            REMARKS_VAL
    ...
    String[] CONFIG_TWO_NCR_BODY_KEYS = {
            APPROXIMATE_CLOSING_DATE_NCR_TWO,
            ORIGINAL_EXPECTED_CLOSING_DATE,
            NUMBER_OF_DAYS_LATE,
            DAMAGE,
            QUALITY_IMPACT,
            NCR_DESCRIPTION,
    ...
    String[] CONFIG_TWO_NCR_BODY_VALUES = {
            APPROXIMATE_CLOSING_DATE_VAL,
            ORIGINAL_EXPECTED_CLOSING_DATE_VAL,
            NUMBER_OF_DAYS_LATE_VAL,
            DAMAGE_VAL,
            QUALITY_IMPACT_VAL,
            NCR_DESCRIPTION_VAL,
    ...
    String[] APPROVAL_OF_SUBCONTRACTORS_BODY_KEYS = {
            APP_OF_SUBCONTR_APPROVAL_NO,
            APP_OF_SUBCONTR_SUB_CONTRACTOR_NAME,
            APP_OF_SUBCONTR_FIELD_OF_ACTIVITY,
            APP_OF_SUBCONTR_SUBPROJECT,
            APP_OF_SUBCONTR_CONTACT
    };

    String[] APPROVAL_OF_SUBCONTRACTORS_BODY_VALUES = {
            APP_OF_SUBCONTR_APPROVAL_NO_VAL,
            APP_OF_SUBCONTR_SUB_CONTRACTOR_NAME_VAL,
            APP_OF_SUBCONTR_FIELD_OF_ACTIVITY_VAL,
            APP_OF_SUBCONTR_SUBPROJECT_VAL,
            APP_OF_SUBCONTR_CONTACT_VAL
    };

    String[] APPROVAL_OF_SUPPLIERS_BODY_KEYS = {
            APP_OF_SUPPL_APPROVAL_NO,
            APP_OF_SUPPL_SUPPLIER_NAME,
            APP_OF_SUPPL_SUBPROJECT,
            APP_OF_SUPPL_CONTACT,
            APP_OF_SUPPL_SUPPLIED_MATERIALS
    };

    String[] APPROVAL_OF_SUPPLIERS_BODY_VALUES = {
            APP_OF_SUPPL_APPROVAL_NO_VAL,
            APP_OF_SUPPL_SUPPLIER_NAME_VAL,
            APP_OF_SUPPL_SUBPROJECT_VAL,
            APP_OF_SUPPL_CONTACT_VAL,
            APP_OF_SUPPL_SUPPLIED_MATERIALS_VAL
    };

    String[] PRELIM_INSPEC_RESULT_BODY_KEYS = {
            PRELIM_MATERIALS_INS_APPROVAL_NO,
            PRELIM_MATERIALS_INS_SUPPLIER_NAME,
            PRELIM_MATERIALS_INS_SUBPROJECT,
            PRELIM_MATERIALS_INS_SOURCE_OF_MATERIAL,
            PRELIM_MATERIALS_INS_MATERIAL_SUPPLIED,
            PRELIM_MATERIALS_INS_MATERIAL_USE
    };

    String[] PRELIM_INSPEC_RESULT_BODY_VALUES = {
            PRELIM_MATERIALS_INS_APPROVAL_NO_VAL,
            PRELIM_MATERIALS_INS_SUPPLIER_NAME_VAL,
            PRELIM_MATERIALS_INS_SUBPROJECT_VAL,
            PRELIM_MATERIALS_INS_SOURCE_OF_MATERIAL_VAL,
    ...
    String[] POC_BODY_KEYS = {
            ...
            POC_UP_TO_SECTION,
            POC_SIDE,
            POC_PARTICIPANTS_IN_TEST,
            POC_MATERIAL_FOR_USE,
            POC_TOOLS_USED,
            POC_DATE_OF_EXECUTION,
            POC_DESCRIPTION_OF_TEST,
            POC_CONCLUSIONS_OF_TEST,
            POC_CORRECTIVE_ACTION
    };

    String[] POC_BODY_VALUES = {
        POC_REPORT_NO_VAL,
        POC_TYPE_OF_TEST_VAL,
        POC_TYPE_OF_TEST_VAL,
        POC_FROM_SECTION_VAL,
        POC_UP_TO_SECTION_VAL,
        POC_SIDE_VAL,
        POC_PARTICIPANTS_IN_TEST_VAL,
        POC_MATERIAL_FOR_USE_VAL,
        POC_TOOLS_USED_VAL,
        POC_DATE_OF_EXECUTION_VAL,
        POC_DESCRIPTION_OF_TEST_VAL,
        POC_CONCLUSIONS_OF_TEST_VAL,
        POC_CORRECTIVE_ACTION_VAL
    };
