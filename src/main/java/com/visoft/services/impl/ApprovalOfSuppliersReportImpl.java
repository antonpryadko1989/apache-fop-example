...
import static com.visoft.services.PoiXSSFCellStyleService.getApprovalOfSuppliersReportStyles;
...
public class ApprovalOfSuppliersReportImpl implements XLSXBuilder{
    ...
    public StreamingResponseBody buildXLSX(TemplateDTO template) throws IOException {
        ...
        XSSFCellStyle[] styles = getApprovalOfSuppliersReportStyles(xlsxObject);

        addLogo(
                xlsxObject, template.getBody()
        );
        addHeaderInfo(
                xlsxObject, APP_OF_SUPPL_TEMPLATE_NAME, VERSION, DATE,
        ...
        setValuesToRow(
                ...
                convertReportBodyToReportBodyRows(
                        ...
                        APPROVAL_OF_SUPPLIERS_BODY_KEYS,
                        APPROVAL_OF_SUPPLIERS_BODY_VALUES
                ),
                styles[1], styles[14], styles[11], styles[16], styles[12], styles[18]
        );
        addEmptyStringWithGivenHeight(xlsxObject, 9);
        addAlignmentRow(
        ...
        addCertifications(
                xlsxObject, CERTIFICATIONS_ITEM, CERTIFICATIONS_EXISTS,
