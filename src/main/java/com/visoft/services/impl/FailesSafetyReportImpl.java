...
import static com.visoft.services.XSSFCellStyleService.getFailesSafetyReportAdditionalDocumentsStyles;
import static com.visoft.services.XSSFCellStyleService.getFailesSafetyReportStyles;
...
public class FailesSafetyReportImpl implements XLSXReportBuilder {
    ...
    public StreamingResponseBody buildXLSX(DeficienciesReportDTO reportDTO) throws IOException {
        ...
        int startRowNum = 1;
        XLSXObject xlsxObject = new XLSXObject(startRowNum, workbook.createSheet(FAILES_SAFETY_REPORT_SHEET_NAME));
        setReportColumnWidths(xlsxObject.getSheet());
        final XSSFCellStyle styles[] = getFailesSafetyReportStyles(xlsxObject);
        final XSSFCellStyle additionalDocumentsStyles[] = getFailesSafetyReportAdditionalDocumentsStyles(xlsxObject);

        addReportLogo(xlsxObject, reportDTO.getReportBody(), styles[0]);
        addHeaderInfo(
                xlsxObject, FAILES_SAFETY_REPORT_NAME, VERSION, DATE,
        ...
        addReportBodyRows(
                ...
                convertReportBodyToReportBodyRows(
                        ...
                        FAILES_SAFETY_REPORT_BODY_KEYS,
                        FAILES_SAFETY_REPORT_BODY_VALUES
                ),
        ...
        addEmptyStringWithGivenHeight(xlsxObject, 9);
        addFailesSafetyReportAdditionalDocuments(
